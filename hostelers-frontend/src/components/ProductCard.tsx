        ...
        {product.familyPackPrice && (
          <button
            ...
            className={`flex items-center gap-1 mt-1 text-[10px] px-2 py-0.5 rounded-full border transition-colors ${
              isFamilyPack ? "bg-accent text-accent-foreground border-accent" : "bg-secondary text-muted-foreground border"
            }`}
          >
              ...
              <button
                ...
                className={`text-xs px-2 py-1 rounded-full border transition-colors ${
                  selectedUnit === unit
                    ...
                    : "bg-secondary text-secondary-foreground border border/50 hover:border-primary"
                }`}
              >
                {unit}
              </button>
